...
FREE = [
    ...
    "Опыт с 2018 года", "Каркасный дом под ключ", "Заселение через месяц",
...
DESCS = [
    ...
    "Каркасный дом под ключ за 30 дней. Работаем по всему Казахстану с 2018 года.",
...
SITELINKS = [
    ...
    ("О компании", "Своё производство, с 2018", "Строим дома с гарантией", FINAL_URL + "#about"),
]
CALLOUTS = ["Дом под ключ за 30 дней", "Фундамент в цене", "Гарантия на дом 1 год",
            ...
            "Строим по Казахстану", "Кровля и доставка в цене", "Опыт с 2018 года"]
SNIPPETS = [
