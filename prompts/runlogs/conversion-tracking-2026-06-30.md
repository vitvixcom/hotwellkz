...
## Апдейт (по запросу): ценность $50 + WhatsApp-клики
- Ценность всех конверсий снижена до **$50**:
  - «Заявка с сайта · форма» (id 7667740729): 750 → **50 USD**
  - «WhatsApp Клик» (id 7077557903, переиспользована): 0 → **50 USD**, primary
- WhatsApp label: `AW-11012690511/kTjSCI_t664aEM-koYMp`
- `site/assets/gtag.js`: добавлена конверсия на клик по любой ссылке WhatsApp
  (`a[href*="wa.me"|"api.whatsapp"|"whatsapp.com"]`) через делегирование — ловит
  все ~2636 страниц без их правки. Форма обратного звонка открывает WhatsApp через
  `window.open` (не клик по ссылке) → засчитывается один раз как форма, без двойного счёта.
